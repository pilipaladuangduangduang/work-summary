...
| style              | string             | 样式
| cover              | string             | 图片
| switch             | string             | 开关：opening、closed
| version_min        | string             | 最小版本
| version_max        | string             | 最大版本
| channel            | array              | 渠道号们，是个数组，即使为单个渠道也是一个数组：[Apple999, ...]
| uri                | string             | 当为页面内容的时候是一个大JSON，也可以是 morelink 协议
